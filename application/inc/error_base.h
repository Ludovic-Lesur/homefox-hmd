...
typedef enum {
    SUCCESS = 0,
    ERROR_NVM_MONITORING_PERIOD,
    ERROR_NVM_AIR_QUALITY_PERIOD,
    ERROR_NVM_ACCELEROMETER_BLANKING_TIME,
    ERROR_NVM_LED_COLOR_SIGFOX_UPLINK,
    ERROR_NVM_LED_COLOR_SIGFOX_DOWNLINK,
    ERROR_NVM_LED_COLOR_TEMPERATURE_HUMIDITY_READING,
    ERROR_NVM_LED_COLOR_AIR_QUALITY_READING,
    ERROR_NVM_LED_COLOR_ACCELEROMETER_READING,
    ...
    ERROR_SIGFOX_EP_DL_LED_COLOR_SIGFOX_UPLINK,
    ERROR_SIGFOX_EP_DL_LED_COLOR_SIGFOX_DOWNLINK,
    ERROR_SIGFOX_EP_DL_LED_COLOR_TEMPERATURE_HUMIDITY_READING,
    ERROR_SIGFOX_EP_DL_LED_COLOR_AIR_QUALITY_READING,
    ERROR_SIGFOX_EP_DL_LED_COLOR_ACCELEROMETER_READING,
    // Peripherals.
