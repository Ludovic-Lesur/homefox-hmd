...
typedef enum {
    ...
    ERROR_SIGFOX_EP_DL_SIGFOX_UPLINK_COLOR,
    ERROR_SIGFOX_EP_DL_SIGFOX_DOWNLINK_COLOR,
    ERROR_SIGFOX_EP_DL_TEMPERATURE_HUMIDITY_READING_COLOR,
    ERROR_SIGFOX_EP_DL_AIR_QUALITY_READING_COLOR,
    ERROR_SIGFOX_EP_DL_ACCELEROMETER_READING_COLOR,
    // Peripherals.
