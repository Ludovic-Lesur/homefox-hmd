...
typedef enum {
    ...
    POWER_ERROR_DRIVER_ENS21X,
    POWER_ERROR_DRIVER_ENS16X,
    POWER_ERROR_DRIVER_FXLS89XXXX,
    POWER_ERROR_DRIVER_LED,
    POWER_ERROR_DRIVER_LPTIM,
    POWER_ERROR_DRIVER_RFE,
    POWER_ERROR_DRIVER_SX126X,
...
typedef enum {
    ...
    POWER_REQUESTER_ID_CLI_AQS,
    POWER_REQUESTER_ID_CLI_ACC,
